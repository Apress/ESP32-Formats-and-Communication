...
void setBeacon()          // function to generate beacon message
{
  ...
  beaconData[10] =  (now.tv_sec*10 >> 24);    // stored as 32-bit number
  beaconData[11] = ((now.tv_sec*10 >> 16) & 0xFF);  // with 0.1sec resolution
  beaconData[12] = ((now.tv_sec*10 >> 8) & 0xFF);
  beaconData[13] =  (now.tv_sec*10 & 0xFF);      // generate beacon message
